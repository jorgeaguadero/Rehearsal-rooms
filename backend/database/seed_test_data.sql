...
INSERT INTO rooms (name, description, capacity, price_per_hour)
VALUES
    ('Sala 1', 'Sala con equipo de sonido profesional', 10, 20.00),
    ('Sala 2', 'Sala con batería y amplificadores', 8, 15.00),
    ('Sala 3', 'Sala para ensayos acústicos', 6, 12.00);
